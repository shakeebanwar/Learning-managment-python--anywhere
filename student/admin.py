...
from .models import Student_Signup,Student_Profile,Application,Student_Course,Student_Query_Admin,Registration,ScrunityForm,Student_Survey,MeetingAppointment,Job_Apply,Student_Submit_Evaluation,Student_Assigment
