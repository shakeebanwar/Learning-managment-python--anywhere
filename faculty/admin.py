...
from .models import Instructor,Department,Course,User_Signup,Materialclass,AssigmentModel,NotificationModel,Teacher_syllabus,TeacherApplication,User_Stories,Query_Admin,CourseVideos,Faculty_Development,Faculty_Evaluation,Exam_Result,Semester,onlinequiz
# Dashboard Labeling
